        ...
        <div class="hero">
            <div class="row justify-content-center">
                <div class="col-lg-6 col-md-8 col-sm-10 custom-col align-left">
                    ...
                    <button type="button" class="btn btn-primary mt-3" style="margin-left: 50px;"  data-sala-id="{{ $salaId }}"  onclick="jugar()">Juguemos</button>
                    <!-- Botón para abrir el card flotante -->
                    <button type="button" class="btn btn-primary mt-3" style="margin-left: 50px;" data-sala-id="{{ $salaId }}" onclick="mostrarCard()">Unete a una Sala</button>

                    <!-- Card flotante -->
                    <div id="cardFlotante" style="display: none; position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%); background-color: #fff; padding: 20px; border-radius: 8px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.2);">
                        <h2>Ingrese un texto</h2>
                        <input type="text" id="textoIngresado" placeholder="Ingrese aquí" style="width: 100%; padding: 10px; margin-bottom: 10px; border: 1px solid #ccc; border-radius: 4px;">
...
.container {
    ...
    padding: 20px; /* Añade un poco de espacio interno al contenedor */
}
...
.hero button {
    padding: 15px 30px; /* Ajusta el padding para más espacio vertical y horizontal */
    margin-top: 15px; /* Ajusta el margen superior para dar espacio entre el select y el botón */
    margin-bottom: 15px; /
    color: #fff;
    border: none;
    border-radius: 5px;
